  ...
  return (
    <div className="space-y-4 md:space-y-6">
      {messages.map((msg, idx) => (
        ...
        >
          <div className={`max-w-[85%] md:max-w-[90%] rounded-2xl md:rounded-[1.5rem] px-4 md:px-6 py-3 md:py-4 ${
            ...
            <div className="flex items-center gap-2 mb-1 md:mb-2">
                <span className={`text-[8px] md:text-[9px] uppercase font-black tracking-widest opacity-60 ${msg.role === MessageRole.USER ? 'text-zinc-400' : 'text-sky-400'}`}>
            ...
            {msg.grounding && msg.grounding.length > 0 && (
              <div className="mt-3 md:mt-4 pt-3 md:pt-4 border-t border-sky-500/20 space-y-2">
                <p className="text-[9px] md:text-[10px] font-black text-sky-400 uppercase tracking-widest">Sources</p>
                  ...
                  {msg.grounding.map((chunk, cIdx) => (
                    chunk.web && (
                      <a 
                        ...
                        className="text-[8px] md:text-[10px] bg-sky-500/10 hover:bg-sky-500/20 text-sky-300 px-2 py-1 rounded border border-sky-500/30 transition-colors flex items-center gap-1"
                      >
      ...
      {isTyping && (
        <div className="flex justify-start">
          <div className="bg-zinc-900/90 border border-sky-500/20 rounded-xl md:rounded-2xl rounded-tl-none px-4 md:px-6 py-3 md:py-4 shadow-2xl flex gap-1.5 items-center">
